...
keytool -genkey -keyalg RSA -alias selfsigned -dname "cn=localhost, ou=MOSERP, o=ORG" -keystore keystore.jks -storepass password -validity 360 -keysize 2048 -keypass password
